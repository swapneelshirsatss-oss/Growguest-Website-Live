      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20 lg:h-24">
          ...
          <nav className="hidden lg:flex items-center space-x-6">
            <a href="/hotel-digital-marketing-services" className="text-sm font-semibold text-slate-600 hover:text-brand-teal transition-colors">Services</a>
            <a href="/hotel-direct-booking-solutions" className="text-sm font-semibold text-slate-600 hover:text-brand-teal transition-colors">Direct Booking Solutions</a>
            <a href="/hospitality-marketing-case-studies" className="text-sm font-semibold text-slate-600 hover:text-brand-teal transition-colors">Case Studies</a>
            <a href="/about-hospitality-marketing-agency" className="text-sm font-semibold text-slate-600 hover:text-brand-teal transition-colors">About Us</a>
            <a href="/blog" className="text-sm font-semibold text-slate-600 hover:text-brand-teal transition-colors">Blog</a>
            <a href="/contact-hospitality-digital-marketing-agency" className="text-sm font-semibold text-slate-600 hover:text-brand-teal transition-colors">Contact</a>
          </nav>

          {/* Desktop CTA */}
          <div className="hidden md:flex items-center space-x-5">
            <a href="https://wa.me/918956907343" target="_blank" rel="noopener noreferrer" className="hidden xl:flex items-center text-sm font-semibold text-slate-600 hover:text-brand-teal transition-colors">
